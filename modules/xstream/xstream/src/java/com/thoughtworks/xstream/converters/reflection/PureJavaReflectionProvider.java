 ...
 * </p>
 * <p>
 * Cannot newInstance: classes without public visibility, non-static inner
 * classes, classes without default constructors. Note that any code in the
 * constructor of a class will be executed when the ObjectFactory instantiates
 * the object.
 * </p>
 * 
 * @author Joe Walnes
		...
		if (Modifier.isFinal(field.getModifiers())) {
			if (JVM.isVersion(5)) {
				...
				throw new ObjectAccessException(
						"Invalid final field " + field.getDeclaringClass().getName() + "." + field.getName());
			}
		}
	}
